        ...
        <div className="relative z-30 max-w-[1440px] mx-auto px-6 lg:px-10 -mt-20 lg:-mt-32">
          <div className="flex flex-col lg:flex-row gap-8 items-start">
            ...
            <div className="w-full lg:w-7/12 order-2 lg:order-1">
              <div className="bg-white rounded-[2.5rem] shadow-2xl p-8 lg:p-12 relative overflow-hidden group">
            ...
            <div className="w-full lg:w-5/12 order-1 lg:order-2 lg:pt-16 space-y-8">
              ...
              <Link to="/leader-board" className="block group">
                <div className="bg-gradient-to-r from-white to-[#f5f8f8] rounded-[2rem] p-6 shadow-lg border border-gray-100 hover:border-[#00bcd4]/30 transition-all relative overflow-hidden">
